...
public class WeatherServlet extends HttpServlet {
   ...
   * Falls back to null (triggering default weather data) if the secret cannot be retrieved.
   *
  ...
  private String getWeatherApiKeyFromSecretsManager() {
    ...
    try {
      ...
      logger.log(Level.WARNING,
          "Unable to retrieve weather API key from AWS Secrets Manager (secret: " + secretName + "): "
              + e.getMessage());
      return null;
    } catch (Exception e) {
      logger.log(Level.WARNING,
