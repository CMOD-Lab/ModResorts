...
public class WeatherServlet extends HttpServlet {
  ...
  /**
   * Replaced IBM WebSphere-specific ServerName API with standard Java approach.
   * Returns server environment information using standard system properties.
   */
  private String configureEnvDiscovery() {
    String serverEnv = "";
    // Replaced com.ibm.websphere.runtime.ServerName with standard Java system properties
    serverEnv += System.getProperty("server.name", "unknown-server");
    serverEnv += System.getProperty("server.full.name", "unknown-full-name");
    return serverEnv;
  }

  /**
   * Replaced IBM WebSphere-specific WsnInitialContextFactory with standard JNDI.
   * Uses standard Jakarta EE JNDI InitialContext without vendor-specific factory.
   */
  private javax.naming.InitialContext setInitialContextProps() {
    // Replaced IBM WebSphere-specific WsnInitialContextFactory with standard JNDI
