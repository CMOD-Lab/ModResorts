...
public class WeatherServlet extends HttpServlet {
  ...
  private void getRealTimeWeatherData(String city, String apiKey, HttpServletResponse response)
    ...
    if (responseCode >= 200 && responseCode < 300) {
      ...
      try {
        ...
        // Updated from StringBuffer to StringBuilder for better performance in Java 21
  ...
  private String configureEnvDiscovery() {
    // Replaced WebSphere-specific ServerName API with standard Java system properties
    String serverEnv = "";
  ...
  private InitialContext setInitialContextProps() {
    // Using standard JNDI InitialContext without WebSphere-specific factory
    // The WsnInitialContextFactory is WebSphere-specific and not available in standard Jakarta EE
