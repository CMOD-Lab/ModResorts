...
// Replaced @Singleton @Startup EJB annotations with @ApplicationScoped CDI bean
// to avoid JVM singleton state that causes inconsistencies in horizontally-scaled containers
@ApplicationScoped
