...
// Removed @Singleton and @Startup EJB annotations to eliminate singleton state storage
// that causes inconsistencies when scaling containers horizontally.
// State is now stateless and fetched fresh per request, suitable for horizontal scaling.
